...
function manipulatestring(string , logString){
    const stringManiPulated = string.toUpperCase();
    logString(stringManiPulated);
}

function logString(stringManiPulated){
    console.log(`The manipulated string is : ${stringManiPulated}`);
}

manipulatestring("sarvesh",logString);